...
namespace Eryph.ComputeClient.Models
{
    ...
    public partial class MachineNetwork
    {
        ...
        /// Initializes a new instance of the MachineNetwork class.
        /// </summary>
        public MachineNetwork(System.Guid? id = default(System.Guid?), string machineId = default(string), string name = default(string), IList<string> ipV4Addresses = default(IList<string>), IList<string> ipV6Addresses = default(IList<string>), string iPv4DefaultGateway = default(string), string iPv6DefaultGateway = default(string), IList<string> dnsServerAddresses = default(IList<string>), IList<string> ipV4Subnets = default(IList<string>), IList<string> ipV6Subnets = default(IList<string>))
        {
            Id = id;
            MachineId = machineId;
            Name = name;
