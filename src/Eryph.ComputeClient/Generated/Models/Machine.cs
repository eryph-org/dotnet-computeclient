...
namespace Eryph.ComputeClient.Models
{
    ...
    public partial class Machine
    {
        ...
        /// 'Pending', 'Error'</param>
        public Machine(string id = default(string), string name = default(string), string status = default(string), IList<MachineNetwork> networks = default(IList<MachineNetwork>))
        {
            Id = id;
            Name = name;
            Status = status;
