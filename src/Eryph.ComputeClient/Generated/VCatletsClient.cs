...
namespace Eryph.ComputeClient
{
    ...
    public partial class VCatletsClient
    {
        ...
        public virtual AsyncPageable<VirtualCatlet> ListAsync(bool? count = null, string project = null, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, VirtualCatlet.DeserializeVirtualCatlet, _clientDiagnostics, _pipeline, "VCatletsClient.List", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<VirtualCatlet> List(bool? count = null, string project = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => RestClient.CreateListRequest(count, project);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => RestClient.CreateListNextPageRequest(nextLink, count, project);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, VirtualCatlet.DeserializeVirtualCatlet, _clientDiagnostics, _pipeline, "VCatletsClient.List", "value", "nextLink", cancellationToken);
        }
    }
}
