...
namespace Haipa.ComputeClient
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<HaipaComputeClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(HaipaComputeClient client)
        {
            if (client == null)
            {
        ...
        public async Task<Haipa.ClientRuntime.HaipaOperationResponse<OperationList>> ListWithHttpMessagesAsync(string select = default(string), string expand = default(string), string filter = default(string), string orderby = default(string), int? top = default(int?), int? skip = default(int?), bool? count = false, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "odata/v1/Operations").ToString();
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<Haipa.ClientRuntime.HaipaOperationResponse<Operation>> GetWithHttpMessagesAsync(System.Guid key, string select = default(string), string expand = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Tracing
            bool _shouldTrace = ServiceClientTracing.IsEnabled;
            string _invocationId = null;
            ...
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "odata/v1/Operations/{key}").ToString();
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<Haipa.ClientRuntime.HaipaOperationResponse<OperationLogEntryList>> GetLogEntriesWithHttpMessagesAsync(System.Guid key, string select = default(string), string expand = default(string), string filter = default(string), string orderby = default(string), int? top = default(int?), int? skip = default(int?), bool? count = false, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Tracing
            bool _shouldTrace = ServiceClientTracing.IsEnabled;
            string _invocationId = null;
            ...
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "odata/v1/Operations/{key}/LogEntries").ToString();
            _url = _url.Replace("{key}", System.Uri.EscapeDataString(Microsoft.Rest.Serialization.SafeJsonConvert.SerializeObject(key, Client.SerializationSettings).Trim('"')));
            List<string> _queryParameters = new List<string>();
            if (select != null)
            {
